...
export const FETCH_ROULETTE_REQUEST = 'FETCH_ROULETTE_REQUEST'
export const FETCH_ROULETTE_SUCCESS = 'FETCH_ROULETTE_SUCCESS'
export const FETCH_ROULETTE_FAILURE = 'FETCH_ROULETTE_FAILURE'
