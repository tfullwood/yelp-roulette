    ...
    return (
        <div className="card">
            ...
            <span className="right floated">
                <a href={encodeURI(`https://google.com/maps/place/${business.location.address1}+${business.location.city}+${business.location.state}+${business.location.zip_code}`)} target="_blank" rel="noopener noreferrer">Google Maps </a>
                |
